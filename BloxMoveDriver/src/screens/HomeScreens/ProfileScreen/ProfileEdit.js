    ...
    getVerificationStatus(accountId)
      .then(async response => {
        ...
        if (result.status === true) {
          ...
          await authDeviceStorage.setAccount(userData);
              ...
              <Controller
                ...
                render={({
                  ...
                  <Input
                    ...
                    onSubmitEditing={() => {
                      Platform.OS === 'android'
                        ? manufactureRef.current?.focus()
                        : manufactureRef.current?.togglePicker(true);
                    }}
                  />
                )}
              />
              <Controller
                ...
                render={({field: {onChange, value, ...field}}) => (
                  <InputSelect
                    ...
                    ref={Platform.OS === 'ios' ? manufactureRef : null}
                    pickerProps={{
                      ref: Platform.OS === 'android' ? manufactureRef : null,
                    }}
                    // onValueChange={() => {
                    //   onChange(value);
                    // }}
